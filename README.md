...
A mock prototype of the types of memory diagrams See++ will generate is available [https://drive.google.com/open?id=1WHp0F-IZ2xwAXuoHmd8ebmyjwxNuq7zXH3J81VJcCoI here]. Ultimately, See++ help students understand pointers, the stack, and the heap in more detail and even debug their own code that manipulates linked lists and trees.
