...
function GitHubLink() {
  return (
    <a
      ...
      className="flex h-7 w-7 cursor-default items-center justify-center rounded-[4px] text-ink-2 transition-colors duration-fast ease-out-soft hover:bg-bg-2 hover:text-ink-0"
    >
